...
public class ConfirmationControllerTest {
    ...
    public void testNotConfirmationMatches() throws Exception {
		...
		List<Match> confirmMatchesUser = confirmationHelper.getMatchesForConfirmation(user, allMatchesForConfirmUser);
		...
		confirmMatchesUser = confirmationHelper.getMatchesForConfirmation(user, allMatchesForConfirmUser);
		...
		List<Match> confirmMatchesOponent = confirmationHelper.getMatchesForConfirmation(oponent, allMatchesForConfirmOponentAfter);
